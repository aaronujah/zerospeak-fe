    ...
    setContent(
      (prev) =>
        prev
          ...
          .filter((item) => item.isBookmarked) // Remove from bookmarked list if unbookmarked
    );
  }, []);
      ...
      <div className="min-h-screen bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600">Content saved for later study</p>
          </div>
              ...
              {content.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-600 mb-4">
                    Start bookmarking content from your feed to save it for
                    later
                  </p>
                </div>
              ) : (
                  ...
                  {!hasMore && content.length > 0 && (
                    <div className="text-center py-8">
                      <p className="text-slate-500">
                        You&apos;ve reached the end of your bookmarked content
                      </p>
                    </div>
                  )}
                </>
